...
import './App.css';
import beepbeep from './beepbeep.mp3';
    ...
    return (
      <div>
        ...
        <div className='time-sets'>
          <button className='btn-small deep-purple lighten-2' id='decrement' onClick={() => changeTime(-60, type)}>
            <i className='material-icons'>arrow_downward</i>
          </button>
          <h3>{formatTime(time)}</h3>
          <button className='btn-small deep-purple lighten-2' id='increment' onClick={() => changeTime(60, type)}>
